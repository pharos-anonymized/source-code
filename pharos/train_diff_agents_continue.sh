...
for num in $agents_nums; do
  ...
  nohup python examples/train.py --algo mappo --env pharos --N_Agents $num --num_env_steps 5000000 --n_rollout_threads 100 --n_eval_rollout_threads 8 "${kv_args[@]}" > "$log_file" 2>&1 &
