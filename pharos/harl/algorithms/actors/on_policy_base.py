...
from harl.utils.models_tools import update_cosine_schedule, update_linear_schedule
...
class OnPolicyBase:
    ...
    def lr_decay_cosine(self, episode, episodes):
        update_cosine_schedule(
            self.actor_optimizer, episode, episodes, self.lr, 0.01 * self.lr
        )
