...
def update_args(unparsed_dict, *args):
    ...
    print(colored("Unparsed arguments:", "red"))
    print(colored(json.dumps(unparsed_dict, indent=4), "red"))
    ...
    def update_dict(dict1, dict2):
        for k in dict2:
            if type(dict2[k]) is dict:
                ...
                if k in dict1:
                    dict2[k] = dict1[k]
                    print(colored(f"Overriding {k} with {dict2[k]}", "green"))
