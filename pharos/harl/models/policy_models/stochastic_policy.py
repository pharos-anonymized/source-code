...
class StochasticPolicy(nn.Module):
    ...
    def predict_action(self, obs: torch.Tensor, available_actions: torch.Tensor):
        """Simple predict function for ONNX export.

        This is a simplified version of the forward method that doesn't handle RNN states or masks

        Args:
            obs: (torch.Tensor) observation inputs into network.
        ...
        action_distribution = self.act.action_out(actor_features, available_actions)
