...
from harl.envs.pharos_discrete.render import AgentVis, save_json


class PharosDiscreteLogger(BaseLogger):
    @override
    def __init__(
    ...
    def eval_log(self, eval_episode: int):
        ...
        # ATTENTION: 这个**不**是在**每个**eval episode结束时调用, 而是在**所有**eval episode结束时调用
