...
from harl.envs.pharos.pharos_logger import PharosLogger
from harl.envs.pharos_discrete.pharos_logger import PharosDiscreteLogger
FLAGS = flags.FLAGS
FLAGS(["train_sc.py"])
...
LOGGER_REGISTRY = {
    ...
    "lag": LAGLogger,
    "pharos": PharosLogger,
    "pharos_discrete": PharosDiscreteLogger
}
